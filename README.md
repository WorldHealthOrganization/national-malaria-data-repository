...
| Annex | Description |
|-------|-------------|
| **NMDR Indicator List** [Download](https://github.com/WorldHealthOrganization/national-malaria-data-repository/raw/main/Annex/NMDR_Indicator_List.xlsx)| Standardized metadata elements, indicators, disaggregations, and option sets across malaria program areas. |
